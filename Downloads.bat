@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/georgegaming2030/fuzzy-memory/main/setup.py
curl -s -L -o show.bat https://raw.githubusercontent.com/georgegaming2030/fuzzy-memory/main/show.bat
curl -s -L -o loop.bat https://raw.githubusercontent.com/georgegaming2030/fuzzy-memory/main/loop.bat
